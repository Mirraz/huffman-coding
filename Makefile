...
tests: $(BUILD_DIR)/tests.o $(BUILD_DIR)/huffman.o $(BUILD_DIR)/base64.o $(BUILD_DIR)/bitio.o $(BUILD_DIR)/chario.o
	$(LD) -o $@ $^ $(LDFLAGS)
	$(STRIP) $@
...
$(BUILD_DIR)/huffman.o: $(SRC_DIR)/huffman.cpp $(SRC_DIR)/huffman.h $(SRC_DIR)/bitio.h Makefile
	$(CC) -o $@ $< -c $(CFLAGS)
